...
public class WeatherController {
  ...
  public ResponseEntity<CityInfo> compareDaylight(@PathVariable("city1") String city1,
  ...
  public ResponseEntity<ArrayList<CityInfo>> compareRain(@PathVariable("city1") String city1,
      @PathVariable("city2") String city2) {
